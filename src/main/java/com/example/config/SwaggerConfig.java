                                ...
                                new SecurityScheme()
                                        ...
                                        .flows(new OAuthFlows()
                                                .authorizationCode(new OAuthFlow()
                                                        .authorizationUrl("http://localhost:9090/realms/school-scheduler/protocol/openid-connect/auth")
                                                        .tokenUrl("http://localhost:9090/realms/school-scheduler/protocol/openid-connect/token")
                                                        .scopes(scopes)
                                                )
                                        )
                        )
